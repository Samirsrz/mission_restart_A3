...
const Installation = () => {
    ...
    return (
      <div className='text-center'>
           <p className='text-5xl mt-6 text-center font-bold'>Your <br /><span className='bg-linear-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text   text-transparent'>Installed </span> Apps</p>
                <p className='text-sm mt-6 text-gray-400 font-bold'>Explore All Trending Apps on the Market developed by us.</p>
